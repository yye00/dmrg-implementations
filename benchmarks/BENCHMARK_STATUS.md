...
- **Affected files**: dmrg2-gpu, pdmrg-gpu, pdmrg-gpu-opt all updated to `use_cpu_svd_ = false`

## What Remains
- GPU benchmarks (pdmrg-gpu, pdmrg-gpu-opt) need running with GPU SVD (old CPU SVD results were purged)
- Any timed-out cases at large L/chi may need revisiting
- pdmrg-opt hybrid cases were partially collected
