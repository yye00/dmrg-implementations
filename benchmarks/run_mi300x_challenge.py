...
def main():
    ...
    if pdmrg_warmup is not None or pdmrg_polish is not None or pdmrg_local is not None:
        print(f"  PDMRG overrides:  warmup={pdmrg_warmup}, polish={pdmrg_polish}, local={pdmrg_local}")
