...
## Session 2026-02-25 — pdmrg2 GEMM-optimization implemented

- Created `pdmrg2/pdmrg/numerics/linalg_utils.py`: `block_davidson` (LOBPCG-style, b=4), `newton_schulz_polar` (NS iteration, tol=NS_TOL=1e-10), `rsvd_cholesky` (sketch→Cholesky-QR2→small SVD, p=RSVD_OVERSAMPLE=10)
...
- Benchmark result (L=16, bond_dim=30): PDMRG2 np=1 is **1.58× faster** than PDMRG np=1 (1.35s vs 2.13s); all |ΔE| < 1e-10; scaling np=1→4 gives 1.48× for both variants
