 ...
 *
 * Standard SVD (cusolverDnDgesvd) loses accuracy for singular values
...
private:
    ...
    struct Workspace {
        ...
        void allocate(size_t work_size, size_t rwork_size) {
            ...
            if (rwork_size > 0 && !d_rwork) {
                cudaMalloc(&d_rwork, rwork_size * sizeof(double));
            }
        }
    ...
    /**
     * @brief Perform standard SVD using cuSOLVER
