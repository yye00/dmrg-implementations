...
// DMRGGPUBase class constructor and run() method. This ensures benchmarks
// are always run with the naive configuration.
...
int test_heisenberg(int L, int chi_max, int n_sweeps) {
    ...
    printf("======================================\n");
    printf("Heisenberg DMRG-GPU-BASE Test (naive)\n");
    printf("======================================\n");
...
int test_tfim(int L, int chi_max, int n_sweeps) {
    ...
    printf("======================================\n");
    printf("TFIM DMRG-GPU-BASE Test (naive)\n");
    printf("======================================\n");
    printf("  L=%d, d=%d, chi_max=%d, D_mpo=%d, sweeps=%d\n", L, d, chi_max, D_mpo, n_sweeps);
...
int test_josephson(int L, int chi_max, int n_sweeps) {
    ...
    printf("======================================\n");
    printf("Josephson Junction DMRG-GPU-BASE Test (naive, complex128)\n");
    printf("======================================\n");
