...
// ============================================================================
// NAIVE BASELINE — dmrg2-gpu-base (two-site)
// ============================================================================
...
// DMRG2GPUBase class constructor and run() method.
...
int test_heisenberg(int L, int chi_max, int n_sweeps) {
    ...
    printf("======================================\n");
    printf("Heisenberg DMRG2-GPU-BASE Test (naive two-site)\n");
    printf("======================================\n");
    ...
    DMRG2GPUBase<double> dmrg(L, d, chi_max, D_mpo, 1e-12);
...
int test_tfim(int L, int chi_max, int n_sweeps) {
    ...
    printf("======================================\n");
    printf("TFIM DMRG2-GPU-BASE Test (naive two-site)\n");
    printf("======================================\n");
    printf("  L=%d, d=%d, chi_max=%d, D_mpo=%d, sweeps=%d\n", L, d, chi_max, D_mpo, n_sweeps);
...
int test_josephson(int L, int chi_max, int n_sweeps) {
    ...
    printf("======================================\n");
    printf("Josephson Junction DMRG2-GPU-BASE Test (naive two-site, complex128)\n");
    printf("======================================\n");
    ...
    DMRG2GPUBase<Complex> dmrg(L, d, chi_max, D_mpo, 1e-12);
    dmrg.initialize_mps_random();
