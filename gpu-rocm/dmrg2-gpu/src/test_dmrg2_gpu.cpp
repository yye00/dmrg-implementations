...
int test_tfim(int L, int chi_max, int n_sweeps,
    ...
    if (!quiet) {
        printf("======================================\n");
        printf("Two-Site TFIM DMRG-GPU Test (float64)\n");
        printf("======================================\n");
        printf("  L=%d, d=%d, chi_max=%d, D_mpo=%d, sweeps=%d\n", L, d, chi_max, D_mpo, n_sweeps);
        printf("  J=%.4f, h=%.4f\n", J, h_field);
        printf("======================================\n\n");
...
int test_j1j2(int L, int chi_max, int n_sweeps, double J1, double J2, bool quiet) {
    ...
    if (!quiet) {
        printf("======================================\n");
        printf("J1-J2 Heisenberg DMRG2-GPU Test (float64)\n");
        printf("======================================\n");
        printf("  L=%d, d=%d, chi_max=%d, D_mpo=%d, sweeps=%d\n", L, d, chi_max, D_mpo, n_sweeps);
        printf("  J1=%.4f, J2=%.4f\n", J1, J2);
        printf("======================================\n\n");
...
// ============================================================================
int test_j1j2j3(int L, int chi_max, int n_sweeps,
    ...
    if (!quiet) {
        printf("======================================\n");
        printf("J1-J2-J3 Heisenberg DMRG2-GPU Test (float64)\n");
        printf("======================================\n");
        printf("  L=%d, d=%d, chi_max=%d, D_mpo=%d, sweeps=%d\n", L, d, chi_max, D_mpo, n_sweeps);
...
int test_ladder(int L_rungs, int chi_max, int n_sweeps,
    ...
    if (!quiet) {
        printf("======================================\n");
        printf("Heisenberg 2-leg Ladder DMRG2-GPU Test (float64)\n");
        printf("======================================\n");
...
int main(int argc, char** argv) {
    ...
    try {
        if (run_josephson) {
            ...
            return test_j1j2j3(L, chi_max, n_sweeps, J1, J2, J3, quiet);
        } else if (run_ladder) {
