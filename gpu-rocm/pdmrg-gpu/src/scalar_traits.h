...
struct ScalarTraits<double> {
    ...
    // d_residual / d_n_sweeps are DEVICE pointers.
    ...
    // For real double, Jacobi (gesvdj) wins at every tested size.
...
struct ScalarTraits<hipDoubleComplex> {
    ...
    // (96x96 DMRG-converged needs 13-21 Jacobi sweeps). Gate by size.
    // See docs/followups/r3_regression_analysis.md.
