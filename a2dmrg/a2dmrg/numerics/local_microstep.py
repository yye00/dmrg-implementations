...
# ===================================================================
# Fast micro-steps using pre-built cached environments (no quimb)
# ===================================================================

def _build_heff_numpy_1site(L_env, W, R_env):
    """Build 1-site effective Hamiltonian from pre-extracted numpy arrays.

    Unlike build_effective_hamiltonian_1site, this takes already-extracted
    numpy arrays and does NOT call _reshape_mpo_tensor.
